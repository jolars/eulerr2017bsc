...
\PassOptionsToPackage{format=plain,font=small,labelfont=bf,labelsep=period,justification=RaggedRight,singlelinecheck=false}{caption}
...
\DeclareFloatSeparators{parsep}{\hskip\marginparsep}
...
\NewDocumentCommand \@placemarginal { m m }
{
...
}
{
    \end{minipage}%
  \end{lrbox}%
  \@placemarginal{#1}{\usebox{\@marginfigurebox}}
}
\makeatother
...
\newcommand{\ts}{\textsuperscript} % Simpler superscript in text
...
% Caption styles (caption package is loaded with footnotes)
