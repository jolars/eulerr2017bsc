...
{\centering \includegraphics[width=\maxwidth]{figure/omega-area-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/ellipsesegment-1-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/ellipsesegment-2-1} 
...
\end{knitrout}
\subcaption{The elliptical diagram from \pkg{eulerr}, with a stress of \ensuremath{3.49\times 10^{-13}}
and diagError of \ensuremath{7.671\times 10^{-8}}.\label{fig:venneulerHard3}}
\end{subfigure}
...
\begin{equation}
\mathcal{I}(\hat{p})_{0.025} = \hat{p} \pm z_{0.025}\sqrt{\frac{\hat{p}(\hat{p}-1)}{n}}.
\label{eq:prop-ci}
\end{equation}
...
$\mathcal{I}(\hat{p})_{0.025}$ is the binomial proportion confidence
...
\For{$N \gets 3:8$}
  ...
  \Do
    ...
    \ForAll{$j \gets$ software}
      ...
      \If{$\mathcal{I}(\hat{p})_{0.025}$ is wider than 0.02 \Or $i \leq 1000$}
      ...
      \EndIf
    \EndFor
  \DoWhile{\All $\mathcal{I}(\hat{p})_{0.025}$ are wider than 0.02 \Or $i \leq 1000$}
\EndFor
\end{algorithmic}
\end{algorithm}
...
$t$-distribution,
\begin{equation}
\mathcal{I}(\bar{x})_{0.025} = \bar{x} \pm t_{0.025,n-1}\frac{s}{\sqrt{n}},
\label{eq:mean-ci}
\end{equation}
...
the accuracy of the various software we are studying. $\mathcal{I}(\bar{x})_{0.025}$
...
\For{$N \gets 3:8$}
  ...
  \Do
    ...
    \EndFor
  \DoWhile{\All $\mathcal{I}(\bar{x})_{0.025}$ are wider than 0.02 \Or $i \leq 1000$}
\EndFor
\end{algorithmic}
\end{algorithm}
