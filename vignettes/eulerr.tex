...
\caption[Optimizing via stress is akin to fitting a least-squares linear regression through the origin]{Optimizing via stress is akin to fitting a least-squares linear regression through the origin.}\label{fig:origin-regress}
\end{marginfigure}
...
and diagError of \ensuremath{9.944\times 10^{-8}}.}
\end{subfigure}
