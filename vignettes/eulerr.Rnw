...
knitr::opts_chunk$set(
  ...
  dev.args =
    if (capabilities("cairo")) {
      if (any(grepl("LinLibertine_R.otf", sysfonts::font_files(), fixed = TRUE))) {
        list(family = "Linux Libertine O")
      } else if (any(grepl("LinLibertine_Rah.ttf", sysfonts::font_files(), fixed = TRUE))) {
        list(family = "Linux Libertine")
      } else {
        list()
      }
    },
